...
function BImg({boldClass }) {
    return (
        <svg onClick={boldClass} width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function UImg({ underClass }) {
    return (
        <svg onClick={underClass} width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function IImg({ italicClass }) {
    return (
        <svg onClick={italicClass} width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function FullEaquals({ fullClass }) {
    return (
        <svg onClick={fullClass} width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function LeftEaquals({ leftClass }) {
    return (
        <svg onClick={leftClass} width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function RightEquals({ rightClass }) {
    return (
        <svg onClick={rightClass} width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function Fix({ fixClass }) {
    return (
        <svg onClick={fixClass} width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
