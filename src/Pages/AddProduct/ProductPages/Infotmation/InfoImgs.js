...
function IImg({ italicClass,activeText }) {
    return (
        <svg  className={`cursor-pointer ${activeText}`} onClick={italicClass} width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
