...
function BImg({boldClass, activeText }) {
    return (
        <svg className={`cursor-pointer ${activeText}`} onClick={boldClass} width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3 6.29053H7.5C8.03043 6.29053 8.53914 6.50124 8.91421 6.87631C9.28929 7.25139 9.5 7.76009 9.5 8.29053C9.5 8.82096 9.28929 9.32967 8.91421 9.70474C8.53914 10.0798 8.03043 10.2905 7.5 10.2905H3V6.29053Z" stroke="#666666" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M3 2.29053H7C7.53043 2.29053 8.03914 2.50124 8.41421 2.87631C8.78929 3.25139 9 3.76009 9 4.29053C9 4.82096 8.78929 5.32967 8.41421 5.70474C8.03914 6.07981 7.53043 6.29053 7 6.29053H3V2.29053Z" stroke="#666666" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
...
function UImg({ underClass }) {
    return (
        <svg className="cursor-pointer"  onClick={underClass} width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function IImg({ italicClass }) {
    return (
        <svg  className="cursor-pointer" onClick={italicClass} width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7 10.2905H2.5" stroke="#666666" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M9.5 2.29053H5" stroke="#666666" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M7.5 2.29053L4.5 10.2905" stroke="#666666" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>

    )
}

function FullEaquals({ fullClass }) {
    return (
        <svg  className="cursor-pointer" onClick={fullClass} width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function LeftEaquals({ leftClass }) {
    return (
        <svg  className="cursor-pointer" onClick={leftClass} width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function RightEquals({ rightClass }) {
    return (
        <svg  className="cursor-pointer" onClick={rightClass} width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function Fix({ fixClass }) {
    return (
        <svg  className="cursor-pointer" onClick={fixClass} width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
