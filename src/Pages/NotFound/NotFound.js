        ...
        <div class="-mx-4 flex">
          <div class="w-full px-4">
            <div class="mx-auto max-w-[400px] text-center">
              <h2 class="mb-2 text-[50px] font-bold leading-none text-supportColor sm:text-[80px] md:text-[100px]">
                404
              </h2>
              <h4 class="mb-3 text-[22px] font-semibold leading-tight text-homeColor">
                Oops! That page can’t be found
              </h4>
              <p class="mb-8 text-lg text-supportColor">
                The page you are looking for it maybe deleted
              </p>
              <a
                href="/"
                class="hover:text-primary inline-block rounded-lg border border-homeColor px-8 py-3 text-center text-base font-semibold text-homeColor transition hover:bg-white"
              >
                Go To Home
              </a>
            </div>
